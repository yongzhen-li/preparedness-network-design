...
void Multi_solution(double solu[10], double f[Mnum], double h[Mnum], int c[Mnum][Nnum], double Q[Mnum], double D_mean[Nnum], double DL[Nnum], double DU[Nnum], double sumDL, double TI)
{
	...
	ofstream eout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/eoutoutput.txt");
	...
	try
	{
		...
		ofstream xout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/XIJ.txt");
		for (i = 0; i < Mnum; i++)
		{
			for (j = 0; j < Nnum; j++)
			{
		...
		ofstream yout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/YI.txt");
		for (i = 0; i < Mnum; i++)
		{
			yout << "   " << YYY[i] << "   ";
		}
		ofstream Iout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/II.txt");
		for (i = 0; i < Mnum; i++)
		{
			Iout << "   " << II[i] << "   ";
		}
...
void Single_solution(double single_solu[10], double f[Mnum], double h[Mnum], int c[Mnum][Nnum], double Q[Mnum], double D_mean[Nnum], double DL[Nnum], double DU[Nnum], double sumDL, double TI) //函数声明，就是具体的求解方法  
{
	IloNumArray YYY(env, Mnum), II(env, Mnum), III(env, Mnum); 
	IloNumArray uu(env, Nnum), vv(env, Mnum);
	ofstream gout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/goutoutput.txt");
	...
	try
	{
		...
		ofstream xout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/single_XIJ.txt");
		for (i = 0; i < Mnum; i++)
		{
			for (j = 0; j < Nnum; j++)
			{
		...
		ofstream yout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/single_YI.txt");
		for (i = 0; i < Mnum; i++)
		{
			yout << "   " << YYY[i] << "   ";
		}
		ofstream Iout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/single_II.txt");
		for (i = 0; i < Mnum; i++)
		{
			Iout << "   " << II[i] << "   ";
		}
...
{
	IloInt i, j;
	ofstream fout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/foutPoutput.txt");
	ofstream result("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/resultoutput.txt");
	...
	ifstream Qfile("C:/Users/20148/Desktop/large study/CPLEX_programming1/input/Qi.txt");
	for (int i = 0; i < 13; i++)
	{
		Qfile >> Q_yuan[i];
	}
	...
	ifstream Ffile("C:/Users/20148/Desktop/large study/CPLEX_programming1/input/Fi.txt");
	for (int i = 0; i < 13; i++)
	{
		Ffile >> F[i];
	}
	...
	fout << "H cost:" << endl;
	ifstream Hfile("C:/Users/20148/Desktop/large study/CPLEX_programming1/input/Hi.txt");
	//Hi
	for (int i = 0; i < 13; i++)
	{
		Hfile >> H[i];
	...
	fout << "D cost:" << endl;      
	ifstream Cfile("C:/Users/20148/Desktop/large study/CPLEX_programming1/input/Dij.txt");
	for (int k = 0; k < 13; k++) {
		for (int j = 0; j < 14; j++) {
			Cfile >> D[k][j];
		}
	...
	for (int k = 0; k < cycle; k++)
	{
		...
		ifstream DMfile("C:/Users/20148/Desktop/large study/CPLEX_programming1/input/MeanDj.txt");
		...
		ofstream dddout("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/doutDemoutput.txt");
		//////////////////////////////// normal //////////////////////////////////////////////////
		dddout << " normal " << endl;
		...
		ifstream OPin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/open.txt");
		
		ifstream Yin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/YI.txt");
		int Multi_Yi[Mnum];
		for (i = 0; i < Mnum; i++)
		{
			Yin >> Multi_Yi[i];
		...
		ifstream Iin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/II.txt");
		...
		ifstream xin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/XIJ.txt");
		...
		ifstream single_OPin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/single_open.txt");
		single_OPin >> OpenF[k][1];

		ifstream single_Yin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/single_YI.txt");
		double single_Yi[Mnum] = { 0.0 };
		for (i = 0; i < Mnum; i++)
		{
			single_Yin >> single_Yi[i];
		}
		ifstream single_Iin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/single_II.txt");
		...
		single_Yin.close();
		single_Iin.close();
		ifstream single_xin("C:/Users/20148/Desktop/large study/CPLEX_programming1/output/single_XIJ.txt");
