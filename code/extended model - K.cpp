...
const int service_time[3] = { 10, 8, 6 }; //{ 10, 8, 6 }
const int service_hours = 10;
const int K_number = 3; // |K|
const int P = 1000000;  
...
IloEnv env;
//******************************Multi*************************
void Multi_solution(double solu[10], double f[Mnum], double h[Mnum], int c[Mnum][Nnum], double Q[Mnum], double D_mean[Nnum], double DL[Nnum], double DU[Nnum], double sumDL, double TI[K_number], int Tao_ij[K_number][Mnum][Nnum])
{
	IloNumArray YYY(env, Mnum), II(env, Mnum), III(env, Mnum); 
	IloNumArray uu(env, Nnum), vv(env, Mnum);
	ofstream eout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/eoutoutput.txt");
	...
	try
	{
		...
		for (int i = 0; i < Mnum; i++)
		{
			...
			{
				LC += c[i][j] * x[i][j];         // total Linkage Cost    
			}
		}
		...
		for (int k = 0; k < K_number; k++) {
			for (int j = 0; j < Nnum; j++)  
			{
				...
				for (int i = 0; i < Mnum; i++) {
					...
					model.add(P* Tao_ij[k][i][j] * x[i][j] - q[k][i][j] >= 0);
					model.add(q[k][i][j] <= I[i]);
				}
		...
		do
		{
			...
			///////////////////////////////////////////////////////////////////////////////////
			////////////////////////////////////////////////////////////////////////////////////
			double objyan[K_number];
			for (int k = 0; k < K_number; k++) {
				objyan[k] = -10000000;
			}

			
			int uu[K_number][Nnum];
			int vv[K_number][Mnum];
			for (int k = 0; k < K_number; k++) {
				for (int i = 0; i < Mnum; i++) {
					vv[k][i] = 0;
				}
			...
			for (int k = 0; k < K_number; k++) {
				if (objyan[k] < -0.10)
				{
					...
					for (int i = 0; i < Mnum; i++) {
						...
						model.add(q[k][i][q[k][i].getSize() - 1] <= I[i]);
					...
					for (int i = 0; i < Mnum; i++)
					{
						...
						for (j = 0; j < Nnum; j++)
						{
							X_is += P * Tao_ij[k][i][j] * x[i][j] * uu[k][j];
						}
		...
		ofstream xout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/XIJ.txt");
		for (i = 0; i < Mnum; i++)
		{
			for (j = 0; j < Nnum; j++)
			{
		...
		ofstream yout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/YI.txt");
		for (i = 0; i < Mnum; i++)
		{
			yout << "   " << YYY[i] << "   ";
		}
		ofstream Iout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/II.txt");
		for (i = 0; i < Mnum; i++)
		{
			Iout << "   " << II[i] << "   ";
		}
...
void Single_solution(double single_solu[10], double f[Mnum], double h[Mnum], int c[Mnum][Nnum], double Q[Mnum], double D_mean[Nnum], double DL[Nnum], double DU[Nnum], double sumDL, double TI[K_number], int Tao_ij[K_number][Mnum][Nnum]) //函数声明，就是具体的求解方法  
{
	IloNumArray YYY(env, Mnum), II(env, Mnum), III(env, Mnum); 
	IloNumArray uu(env, Nnum), vv(env, Mnum);
	ofstream gout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/goutoutput.txt");
	...
	try
	{
		...
		NumVarMatrix3 q(env, K_number); //q_kiS
		for (int k = 0; k < K_number; k++) {
			q[k] = NumVarMatrix(env, Mnum);
			for (i = 0; i < Mnum; i++)
			{
		...
		ofstream xout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/single_XIJ.txt");
		for (i = 0; i < Mnum; i++)
		{
			for (j = 0; j < Nnum; j++)
			{
		...
		ofstream yout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/single_YI.txt");
		for (i = 0; i < Mnum; i++)
		{
			yout << "   " << YYY[i] << "   ";
		}
		ofstream Iout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/single_II.txt");
		for (i = 0; i < Mnum; i++)
		{
			Iout << "   " << II[i] << "   ";
		}
...
{
	IloInt i, j;
	ofstream fout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/foutPoutput.txt");
	ofstream result("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/resultoutput.txt");
	...
	ifstream Qfile("C:/Users/20148/Desktop/extended study/CPLEX_programming1/input/Qi.txt");
	...
	ifstream Ffile("C:/Users/20148/Desktop/extended study/CPLEX_programming1/input/Fi.txt");
	for (int i = 0; i < 13; i++)
	{
		Ffile >> F[i];
	}
	...
	fout << "H cost:" << endl;
	ifstream Hfile("C:/Users/20148/Desktop/extended study/CPLEX_programming1/input/Hi.txt");
	//Hi
	for (int i = 0; i < 13; i++)
	{
		Hfile >> H[i];
	...
	fout << "D cost:" << endl;      
	ifstream Cfile("C:/Users/20148/Desktop/extended study/CPLEX_programming1/input/Dij.txt");
	for (int k = 0; k < 13; k++) {
		for (int j = 0; j < 14; j++) {
			Cfile >> D[k][j];
		}
	...
	int Tao_ij[K_number][Mnum][Nnum];
	for (int s = 0; s < K_number; s++) {
		for (int i = 0; i < Mnum; i++)
		{
			for (int j = 0; j < Nnum; j++)
			{
	...
	double Coverage_distan[K_number];
	for (int s = 0; s < K_number; s++) {
	...
	{
		ifstream DMfile("C:/Users/20148/Desktop/extended study/CPLEX_programming1/input/MeanDj.txt");
		...
		for (int k = 0; k < K_number;k++) {
			TI[k] = sumDM + sqrt(-log(eps[k]) * he / 2);
			fout << "TI[" << k <<" ] = " << TI[k] << endl << endl;
		}
		



		ofstream dddout("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/doutDemoutput.txt");
		//////////////////////////////// normal //////////////////////////////////////////////////
		dddout << " normal " << endl;
		...
		Multi_solution(solu, f, h, c, Q, DM, DL, DU, sumDL, TI, Tao_ij);
		result << "*****Multi*****" << endl;
		...
		ifstream OPin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/open.txt");
		
		ifstream Yin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/YI.txt");
		int Multi_Yi[Mnum];
		for (i = 0; i < Mnum; i++)
		{
			Yin >> Multi_Yi[i];
		...
		ifstream Iin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/II.txt");
		...
		ifstream xin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/XIJ.txt");
		...
		Single_solution(single_solu, f, h, c, Q, DM, DL, DU, sumDL, TI, Tao_ij);
		result << "*****Single*****" << endl;
		...
		ifstream single_OPin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/single_open.txt");
		single_OPin >> OpenF[k][1];

		ifstream single_Yin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/single_YI.txt");
		double single_Yi[Mnum] = { 0.0 };
		for (i = 0; i < Mnum; i++)
		{
			single_Yin >> single_Yi[i];
		}
		ifstream single_Iin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/single_II.txt");
		...
		single_Yin.close();
		single_Iin.close();
		ifstream single_xin("C:/Users/20148/Desktop/extended study/CPLEX_programming1/output/single_XIJ.txt");
