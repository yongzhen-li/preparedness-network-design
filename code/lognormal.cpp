...
const int Mnum = 13;   //M 
const int Nnum = 14;   // N 
const double deviation = 0.2; //0.2, 0.6, 1, 1.4, 1.8
...
void Multi_solution(double solu[10], double f[Mnum], double h[Mnum], int c[Mnum][Nnum], double Q[Mnum], double D_mean[Nnum], double DL[Nnum], double DU[Nnum], double sumDL, double TI)
{
	...
	ofstream eout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/eoutoutput.txt");
	eout << "Starting" << endl;
	try
	{
		IloEnv env;
		...
		do
		{
			...
			if (objyan < -0.10)
			{
				...
				for (i = 0; i < Mnum; i++)
				{
					...
					eout << endl;//solu[1] += XXX[i][j] * YYY[i];
				}
				eout << "----------------------------" << endl;
		...
		ofstream xout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/XIJ.txt");
		for (i = 0; i < Mnum; i++)
		{
			for (j = 0; j < Nnum; j++)
			{
		...
		ofstream yout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/YI.txt");
		for (i = 0; i < Mnum; i++)
		{
			yout << "   " << YYY[i] << "   ";
		}
		ofstream Iout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/II.txt");
		for (i = 0; i < Mnum; i++)
		{
			Iout << "   " << II[i] << "   ";
		}
...
void Single_solution(double single_solu[10], double f[Mnum], double h[Mnum], int c[Mnum][Nnum], double Q[Mnum], double D_mean[Nnum], double DL[Nnum], double DU[Nnum], double sumDL, double TI) //函数声明，就是具体的求解方法  
{
	IloNumArray YYY(env, Mnum), II(env, Mnum), III(env, Mnum); 
	IloNumArray uu(env, Nnum), vv(env, Mnum);
	ofstream gout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/goutoutput.txt");
	...
	try
	{
		...
		ofstream xout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/single_XIJ.txt");
		for (i = 0; i < Mnum; i++)
		{
			for (j = 0; j < Nnum; j++)
			{
			...
			xout << endl;//single_solu[1] += XXX[i][j] * YYY[i];
		}
		


		ofstream yout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/single_YI.txt");
		for (i = 0; i < Mnum; i++)
		{
			yout << "   " << YYY[i] << "   ";
		}
		ofstream Iout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/single_II.txt");
		for (i = 0; i < Mnum; i++)
		{
			Iout << "   " << II[i] << "   ";
		}
		...
		/////////////////////////////////////////////////////////////////////////////////////
		gout << "_______Real_Sum_I   =   " << Real_Sum_I << endl;
...
int main(int argc, char** argv)
{
	...
	ofstream fout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/foutPoutput.txt");
	ofstream result("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/resultoutput.txt");
	...
	ifstream Qfile("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/input/Qi.txt");
	for (int i = 0; i < 13; i++)
	{
		Qfile >> Q_yuan[i];
	}
	...
	ifstream Ffile("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/input/Fi.txt");
	for (int i = 0; i < 13; i++)
	{
		Ffile >> F[i];
	}
	...
	fout << "H cost:" << endl;
	ifstream Hfile("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/input/Hi.txt");
	...
	fout << "D cost:" << endl;      
	ifstream Cfile("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/input/Dij.txt");
	for (int k = 0; k < 13; k++) {
		for (int j = 0; j < 14; j++) {
			Cfile >> D[k][j];
		}
	...
	for (int k = 0; k < cycle; k++)
	{
		...
		ifstream DMfile("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/input/MeanDj.txt");
		...
		vector<double> log_mean(Nnum, 0);
		vector<double> log_var(Nnum, 0);
		vector<double> log_var_de(Nnum, 0);

		std::default_random_engine generator(5 + k); // seed for reproducibility

		for (int j = 0; j < Nnum; j++)
		{
				
			log_var[j] = log(1.0 + V[j] / (miu[j] * miu[j]));  // σ^2 for the base normal
			log_mean[j] = log(miu[j]) - log_var[j] / 2.0;       // μ for the base normal
			log_var_de[j] = log_var[j] * deviation;


			std::normal_distribution<double> dist(log_mean[j], sqrt(log_var_de[j]));

			for (int cpj = 0; cpj < 100; cpj++)
			{
				D[j][cpj] = exp(dist(generator));
		...
		ofstream dddout("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/doutDemoutput.txt");


		//////////////////////////////// lognormal //////////////////////////////////////////////////

		dddout << " lognormal " << endl;
		static double dn[realization_num][Nnum], du[realization_num][Nnum], dt[realization_num][Nnum];

		std::default_random_engine generator2(50 + k); // seed for reproducibility
		...
		for (int k = 0; k < realization_num; k++)
		{
			for (int j = 0; j < Nnum; j++)
			{
				...
				std::normal_distribution<double> dist2(log_mean[j], sqrt(log_var_de[j]));

				double sample = exp(dist2(generator2));

				dn[k][j] = (sample > 0) ? sample : 0.0;
				dddout << "dn[" << k << "][" << j << "]= " << dn[k][j] << " ";
			}
			dddout << endl;
		}
		...
		ifstream OPin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/open.txt");
		
		ifstream Yin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/YI.txt");
		int Multi_Yi[Mnum];
		for (i = 0; i < Mnum; i++)
		{
			Yin >> Multi_Yi[i];
		...
		ifstream Iin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/II.txt");
		...
		ifstream xin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/XIJ.txt");
		...
		ifstream single_OPin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/single_open.txt");
		single_OPin >> OpenF[k][1];

		ifstream single_Yin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/single_YI.txt");
		double single_Yi[Mnum] = { 0.0 };
		for (i = 0; i < Mnum; i++)
		{
			single_Yin >> single_Yi[i];
		}
		ifstream single_Iin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/single_II.txt");
		...
		single_Yin.close();
		single_Iin.close();
		ifstream single_xin("C:/Users/20148/Desktop/lognormal/CPLEX_programming1/output/single_XIJ.txt");
