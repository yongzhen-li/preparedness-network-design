...
This project contains the source data for the paper "Emergency Preparedness Network Design: Joint Chance-Constrained Large-Scale Optimization and a Case Study of Typhoon Maria".
...
* Dij.txt records the distance between each relief faciity and each affected area.
